...
function getRooms($date,$db){
	...
	if(!$all){$db->query("INSERT INTO bron_time(id_room,date,seans_1,seans_2,seans_3,seans_4,seans_5,seans_6,seans_7,seans_8,seans_9) VALUES('2','".$date."','0','0','0','0','0','0','0','0','0'),('3','".$date."','0','0','0','0','0','0','0','0','0'),('4','".$date."','0','0','0','0','0','0','0','0','0')");}
	$timtm=0;
	if(date("w",time()+$timtm)==0){$W='<span style="color:#000080;">вс</span>';}
	...
	if(date("w",time()+$timtm)==6){$W='<span style="color:#000080;">сб</span>';}
...
$color4ik='#000080;border:none;cursor:default';
...
$result.='<tr><td style="text-align:left;"><a href="/'.$da.'/" style="text-decoration:none;color:#fff;"><div class="fiol" style="cursor:pointer;">'.$vals['name_room'].'<br>'.$vals['name'].'<br><span style="font-size:13px;">3-15 человек, до 60 мин</span></div></a></td>
<td onClick="bron_okno(\''.$date.'\',\'seans_1\',\''.$vals['id'].'\',\''.$vals['name_room'].'\',\''.$vals['seans_1'].'\',\''.$vals['name'].'\');"><div class="bor_bron" style="'.$seans_1.'" >'.$vals['seans_1'].'</div></td>
<td onClick="bron_okno(\''.$date.'\',\'seans_2\',\''.$vals['id'].'\',\''.$vals['name_room'].'\',\''.$vals['seans_2'].'\',\''.$vals['name'].'\');"><div class="bor_bron" style="'.$seans_2.'">'.$vals['seans_2'].'</div></td>
<td onClick="bron_okno(\''.$date.'\',\'seans_3\',\''.$vals['id'].'\',\''.$vals['name_room'].'\',\''.$vals['seans_3'].'\',\''.$vals['name'].'\');"><div class="bor_bron" style="'.$seans_3.'">'.$vals['seans_3'].'</div></td>
<td onClick="bron_okno(\''.$date.'\',\'seans_4\',\''.$vals['id'].'\',\''.$vals['name_room'].'\',\''.$vals['seans_4'].'\',\''.$vals['name'].'\');"><div class="bor_bron" style="'.$seans_4.'">'.$vals['seans_4'].'</div></td>
<td onClick="bron_okno(\''.$date.'\',\'seans_5\',\''.$vals['id'].'\',\''.$vals['name_room'].'\',\''.$vals['seans_5'].'\',\''.$vals['name'].'\');"><div class="bor_bron" style="'.$seans_5.'" >'.$vals['seans_5'].'</div></td>
<td onClick="bron_okno(\''.$date.'\',\'seans_6\',\''.$vals['id'].'\',\''.$vals['name_room'].'\',\''.$vals['seans_6'].'\',\''.$vals['name'].'\');"><div class="bor_bron" style="'.$seans_6.'">'.$vals['seans_6'].'</div></td>
<td onClick="bron_okno(\''.$date.'\',\'seans_7\',\''.$vals['id'].'\',\''.$vals['name_room'].'\',\''.$vals['seans_7'].'\',\''.$vals['name'].'\');"><div class="bor_bron" style="'.$seans_7.'">'.$vals['seans_7'].'</div></td>
<td onClick="bron_okno(\''.$date.'\',\'seans_8\',\''.$vals['id'].'\',\''.$vals['name_room'].'\',\''.$vals['seans_8'].'\',\''.$vals['name'].'\');"><div class="bor_bron" style="'.$seans_8.'">'.$vals['seans_8'].'</div></td>
<td onClick="bron_okno(\''.$date.'\',\'seans_9\',\''.$vals['id'].'\',\''.$vals['name_room'].'\',\''.$vals['seans_9'].'\',\''.$vals['name'].'\');"><div class="bor_bron" style="'.$seans_9.'">'.$vals['seans_9'].'</div></td>
</tr>';
...
function getRooms_admin($date,$db){
	$all=$db->getRow("SELECT * FROM bron_time WHERE date=?s",$date);
	if(!$all){$db->query("INSERT INTO bron_time(id_room,date,seans_1,seans_2,seans_3,seans_4,seans_5,seans_6,seans_7,seans_8,seans_9) VALUES('1','".$date."','0','0','0','0','0','0','0','0','0'),('2','".$date."','0','0','0','0','0','0','0','0','0'),('3','".$date."','0','0','0','0','0','0','0','0','0'),('5','".$date."','0','0','0','0','0','0','0','0','0')");}
	$timtm=0;
	if(date("w",time()+$timtm)==0){$W='<span style="color:#000080;">вс</span>';}
	if(date("w",time()+$timtm)==1){$W='пн';}
	if(date("w",time()+$timtm)==2){$W='вт';}
...
if($room['seans_8']==1){$seans_8='background:'.$color4ik.';';}
if($room['seans_9']==1){$seans_9='background:'.$color4ik.';';}
$result.='<tr><td style="text-align:left;"><div class="fiol">'.$vals['name_room'].'<br>'.$vals['name'].'<br><span style="font-size:13px;">15-30 человек, до 60 мин</span></div></td>
